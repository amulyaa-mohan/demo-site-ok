# Git &amp; GitHub Workshop: Demo Site okay okay
...
| `script.js`  | The little bit of interactivity |
| `README.md`  | This file — GitHub shows it on the repo home page |

## Commands we practise
...
git diff                 # compare before and after
